...
export default function Contact() {
  ...
  return (
    <section id="contato" className="py-24 px-6 relative overflow-hidden">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-violet-600/10 rounded-full blur-3xl -z-10" />
      <div className="max-w-5xl mx-auto text-center" ref={ref}>
        ...
        >
          ...
          <p className="text-slate-500 text-sm mb-10">cm.guilherme28@gmail.com</p>
